...
const Footer = () => {
  return (
    <div className="px-2.5 md:px-[5%] lg:px-[10%] text-sm mt-10">
      <div className="w-15">
        <Link to={"/"} className="">
          <img src="/logo.jpg" alt="logo" className="w-full" />
        </Link>
      </div>
      <div className="text-[12px] gap-y-6 grid grid-cols-3 md:grid-cols-4 justify-between my-5 py-5 border-b border-slate-400">
